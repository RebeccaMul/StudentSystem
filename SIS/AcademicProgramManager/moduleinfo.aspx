<%@ Page Language="C#" AutoEventWireup="true" CodeFile="moduleinfo.aspx.cs" Inherits="AcademicProgramManager_moduleinfo" %>
            ...
            <asp:ListView ID="ListView1" runat="server" DataSourceID="displaymodule">
             ...
             <div class="panel panel-default">
                <div class="panel-heading">
                        <asp:HyperLink ID="Hyperlink1" runat="Server" Text="Edit " float="right" CssClass="btn btn-default" Style="float: right;"
                                                            NavigateUrl='<%# "viewmodule.aspx?moduleID="+Eval("moduleID") %>'>Edit</asp:HyperLink>
