<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editModules.aspx.cs" Inherits="AcademicProgramManager_editModules" %>
        ...
        <div class="container body">
            <div class="main_container">
              ...
              <SelectParameters>
               ...
               <div class="header_02"><b><i>Welcome to the Academic Program Manager Editing Page</i></b></div>
   
              <br />


            <p>
                Module Name: <asp:TextBox ID="modulenametext" style="margin:0 0 0 05px" width="280" runat="server"></asp:TextBox>
            </p>

            <p>
                Module Description: <asp:TextBox ID="moduledescriptiontext" style="margin:0 0 0 05px" width="320" runat="server"></asp:TextBox>
            </p>

          

            <p>
                Units: <asp:TextBox ID="unitstext" style="margin:0 0 0 05px" width="50" runat="server"></asp:TextBox>
            </p>

            <p>
            Compulsory: <asp:TextBox ID="compulsorytext" style="margin:0 0 0 05px" width="50" runat="server"></asp:TextBox>
                ...
                <asp:Button ID="updateModule" runat="server" Text="Save" OnClick="module_Click" />
