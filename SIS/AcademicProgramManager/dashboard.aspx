<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashboard.aspx.cs" Inherits="AcademicProgramManager_dashboard" %>
      ...
      <asp:SqlDataSource ID="configSource" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>'
                           ...
                           <asp:Label ID="welcomeAlert" runat="server" Font-Size="15px" Text='<%# Eval("welcomeAlert") %>'></asp:Label>
                                    ...
                                    <asp:SqlDataSource ID="HomeDetails" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>'
                                        SelectCommand="SELECT * FROM SIS_ACADEMIC_PROGRAM_MANAGER 
                  INNER JOIN SIS_USER ON SIS_ACADEMIC_PROGRAM_MANAGER.userID = SIS_USER.userID
                  WHERE SIS_ACADEMIC_PROGRAM_MANAGER.userID=@ID ">
                                        <SelectParameters>
