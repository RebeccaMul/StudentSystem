<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student.aspx.cs" Inherits="AcademicProgramManager_Student" %>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <asp:SqlDataSource ID="UserDetails" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT *, firstName +' '+ lastName AS name FROM SIS_STUDENT WHERE ([firstName] LIKE '%' + @FName + '%') OR ([lastName] LIKE '%' + @LName + '%') OR ([studentNo] LIKE '%' + @StudentNo + '%')">
  ...
  <div class="panel-body">
    ...
    Course
      ...
      <!--              Final Module Marks
                           ...
                           <asp:Label Text='<%# Eval("percentage") %>' runat="server" ID="percentage" /><br />
     ...
     -->
      ...
      <!-- sql data source for one table to pull data from mylittleadmin-->  <!-- Session used as filtering parameter-->
         ...
         SelectCommand="SELECT *, firstName +' '+ lastName AS name FROM SIS_STUDENT">
            ...
            <div class="col-lg-3 col-md-4  col-sm-12 col-xs-12">
                <div class="panel panel-default">
  <div class="panel-heading"><asp:HyperLink ID="editLink" runat="Server" Text="Edit Personal Information" float="right" CssClass="btn btn-default" Style="float: right;"
                                                            NavigateUrl='<%# "Student_Edit.aspx?studentID="+Eval("studentID") + "&userID=" + Eval ("userID") %>'>Edit</asp:HyperLink>
                                                        <asp:HyperLink ID="HyperLink1" runat="Server" Text="" NavigateUrl='<%# "Student_Edit.aspx?studentID="+Eval("studentID") + "&userID" + Eval ("userID") %>'>
                                                            <asp:Label Text='<%# Eval("name") %>' runat="server" ID="firstNameLabel" />
