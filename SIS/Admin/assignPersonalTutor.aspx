<%@ Page Language="C#" AutoEventWireup="true" CodeFile="assignPersonalTutor.aspx.cs" Inherits="Admin_assignPersonalTutor" %>
...
<body class="nav-md">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <!-- SM - enables Admins to assign Personal Tutors to students-->
                                     <asp:SqlDataSource ID="personalTut" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT *, firstname + '' + lastname AS name FROM SIS_STUDENT WHERE SIS_STUDENT.studentID = @id">  
                                             
                <SelectParameters>
                <asp:QueryStringParameter Name="id" Type="Int32" QueryStringField="studentID" />
            </SelectParameters>
                </asp:SqlDataSource>
                     ...
                     <asp:ListView ID="ListView2" runat="server" DataSourceID="personalTut">
  ...
  <div class="panel-body">
    ...
    Course
              ...
              <!-- SM - Personal Tutor Drop Down List enables admin to allocate student with Personal Tutor -->
                               
            &nbsp  &nbsp   <b> Personal Tutor: </b>  
                         <asp:DropDownList ID="tutor" runat="server" margin-left="20px;" DataSourceID="readfrommodules"
                           DataTextField="fullName" DataValueField="lecturerID">  </asp:DropDownList>
                         
                          
            <asp:SqlDataSource ID="readfrommodules" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_LECTURER">  
                   </asp:SqlDataSource>
             ...
             <asp:Button ID="assignModule" runat="server" Text="Assign" CssClass="btn-primary" OnClick="assignTutorBtn_Click" />

                                    
             <asp:Button ID="backBtn" runat="server" Text="Back" CssClass="btn-primary" OnClick="backBtn_Click" />
               <br />
               <br />
