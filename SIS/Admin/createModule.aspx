<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createModule.aspx.cs" Inherits="Admin_createModule" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <!-- JC - Form to enter details for new module -->
                                    <div class="col-md-6">
                                        Module Name
                                    <asp:TextBox ID="newModule" CssClass="form-control" Width="50%" runat="server"></asp:TextBox><br />
                                        Module Code
                                    <asp:TextBox ID="newCode" CssClass="form-control" Width="50%" runat="server"></asp:TextBox><br />
                                        Module Description
                                    <asp:TextBox ID="newDesc" CssClass="form-control" Width="50%" runat="server"></asp:TextBox><br />
                                        Module Units
                                    <asp:TextBox ID="newUnits" CssClass="form-control" Width="50%" runat="server"></asp:TextBox><br />
                                    </div>
                                    <div class="col-md-6">
                                        Module Compulsary<br />
                                        <asp:DropDownList ID="comp" runat="server" CssClass="form-control" Width="50%">
                                            <asp:ListItem Text="Yes" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="No" Value="1"></asp:ListItem>
                                        </asp:DropDownList><br />

                                        <!-- JC - SQL and dropdown list for module, this ensure an actual registered lecturer is assigned to a module and not random name -->

                                        <asp:SqlDataSource ID="availableLecturer" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT lecturerID, firstName +' '+ lastName AS name FROM SIS_LECTURER"></asp:SqlDataSource>

                                        Module Lecturer<br />
                                        <asp:DropDownList ID="LecturerList" DataSourceID="availableLecturer" DataTextField="name" DataValueField="lecturerID" Width="50%" CssClass="form-control" runat="server"></asp:DropDownList><br />
                                        Module Level 
                                    <asp:TextBox ID="newLevel" CssClass="form-control" Width="50%" runat="server"></asp:TextBox><br />
                                        Module Semester
                                        <br />
                                        <asp:DropDownList ID="newSem" runat="server" CssClass="form-control" Width="50%">
                                    ...
                                    <br />
                                    <div class="col-md-12">
                                        <asp:Button ID="newModuleButton" runat="server" CssClass="btn btn-primary" Text="Submit" OnClick="newModuleButton_Click" />
                                        <br />
                                        <asp:Label ID="complete" runat="server" Text=""></asp:Label>
                                    </div>
