<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Timetable_Edit.aspx.cs" Inherits="Admin_Timetable_Edit" %>
...
<body class="nav-md">
    <form id="form1" runat="server">
        <div class="container body">
          ...
          <asp:SqlDataSource ID="editEvent" runat="server" 
         ...
         SelectCommand="SELECT * FROM SIS_EVENT">
                ...
                <asp:ListView ID="timetable" runat="server" DataSourceID="editEvent">
...
<div class="col-lg-3 col-md-4  col-sm-12 col-xs-12">
  ...
  <div class="panel-heading">
                                    ...
                                    <asp:HyperLink ID="editBtn" runat="server" text="Edit" class="btn btn-primary" style="float: right;" NavigateUrl='<%#"editevent.aspx?eventID=" + Eval("eventid") %>'></asp:HyperLink>  
             ...
             <br />
                     <b>All Day </b>
                           <asp:Checkbox ID="all_dayLabel" runat="server" Checked='<%# Eval("all_day") %>'  Enabled="false"></asp:Checkbox>
                                        ...
                                        <asp:SqlDataSource ID="EventDetails" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_EVENT WHERE ([title] LIKE '%' + @title + '%') OR ([description] LIKE '%' + @Location + '%') OR ([event_start] LIKE '%' + @Date + '%') OR ([event_end] LIKE '%' + @date + '%') OR (cast([event_start] as date) LIKE '%' + @date + '%')">
