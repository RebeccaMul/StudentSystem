<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editModule.aspx.cs" Inherits="Admin_editModule" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Edit Module</h2>
                                    <!--JC - Form created to gather data for editing module information -->
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    ...
                                    <br />
                                        ...
                                        <!--JC - SQL and dropdown list to ensure valid lecturer is assigned to module -->
                                    ...
                                    <br />
                                        ...
                                        <!-- JC - Static variable Dropdown list -->
                                        Status
