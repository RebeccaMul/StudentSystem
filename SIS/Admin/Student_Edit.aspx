<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student_Edit.aspx.cs" Inherits="Admin_Student_Edit" %>
                                            ...
                                            <div class="col-lg-4 col-sm-12 col-xs-12">
                                              ...
                                              <br />
                                               ...
                                               <br />
                                                 ...
                                                 <!-- Rachael - drop down list -->

                                                         <p>Status</p>
                                                                <asp:DropDownList ID="StudentStatus" runat="server" CssClass="form-control">
                                           
                                                                    <asp:ListItem Text="Normal" Value="Normal" ></asp:ListItem>
                                                                    <asp:ListItem Text="Withdrawn" Value="Withdrawn" ></asp:ListItem>
                                                                     <asp:ListItem Text="Temporarily Withdrawn" Value="Temporarily Withdrawn" ></asp:ListItem>
