<%@ Page Language="C#" AutoEventWireup="true" CodeFile="financePaid.aspx.cs" Inherits="Admin_financePaid" %>
            ...
            <div class="main_container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <!-- JC - SQL used when admin user uses search facility -->

                                    <asp:SqlDataSource ID="UserDetails" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT *, firstName +' '+ lastName AS name FROM SIS_FINANCE
               INNER JOIN SIS_STUDENT ON SIS_STUDENT.studentID = SIS_FINANCE.studentID WHERE ([firstName] LIKE '%' + @FName + '%') OR ([lastName] LIKE '%' + @LName + '%') OR ([studentNo] LIKE '%' + @StudentNo + '%')">
                                ...
                                <br />
                                    ...
                                    <!-- JC - Listview for search user, will display above other students -->
                            ...
                            <asp:Label Text='<%# Eval("level") %>' runat="server" ID="levelLabel" /><br />
                                                        <br />
                                                        Fees Paid
                            <asp:Label Text='<%# Eval("amountPaid") %>' runat="server" ID="Label1" />
                                                        <br />

                                                        <b>Fees Outstanding
                            <asp:Label Text='<%# Eval("feesOutstanding") %>' runat="server" ID="Label2" /><br />
                                                        </b>
                                                        <br />
                                                    </div>
                                                </div>
                                    ...
                                    <br />
                                    <div class="col-md-12" style="border-top: dashed">
                                        <br />
                                    </div>


                                    <!-- sql data source for all students -->

                                    <asp:SqlDataSource ID="displayfinance" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:dbconnect %>"
                                        SelectCommand="SELECT *, firstName +' '+ lastName AS name FROM SIS_FINANCE
               INNER JOIN SIS_STUDENT ON SIS_STUDENT.studentID = SIS_FINANCE.studentID"></asp:SqlDataSource>
                                    <!-- List view to display the content from all student SQL source-->
                                    <br />
