<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userTimetable.aspx.cs" Inherits="Admin_userTimetable" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Timetable</h2>
                                    <!--  SM: Delete Timetable Events button  -->
                                    <asp:HyperLink ID="deleteBtn" runat="server" class="btn btn-primary" style="float: right;" NavigateUrl="Timetable_Remove.aspx">Delete Events</asp:HyperLink> 
                                    <!--  RMU: Edit Timetable Events button -->
                                    <asp:HyperLink ID="editBtn" runat="server" class="btn btn-primary" style="float: right;" NavigateUrl="Timetable_Edit.aspx">Edit Events</asp:HyperLink>  
                                    <!--  SM: Add Timetable Events button -->
                                    <asp:HyperLink ID="addBtn" runat="server" class="btn btn-primary" style="float: right;" NavigateUrl="Timetable_Add.aspx">Add Events</asp:HyperLink> 
                               ...
                               <!--JC - Script Manager handles the loading of FullCalendar -->
