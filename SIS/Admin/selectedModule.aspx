<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selectedModule.aspx.cs" Inherits="admin_selectedModule" %>
             ...
             <asp:QueryStringParameter Name="myid" QueryStringField="moduleid" Type="Int32" />
              ...
              <!-- List view to display the content from db--> <!-- Hyper link to pass module ID to next page-->
                 ...
                 <div id="div1" style="padding:10px" >       
                        ...
                        <asp:Button ID="editdesc" runat="server" CssClass="btn btn-primary" width="150px" Text="Edit Module Description" OnClick="editdesc_Click" /> 
                         <br />
                       <asp:Button ID="Sendresults" runat="server" CssClass="btn btn-primary" Width="150px" Text="Submit Assignment/Exam Result" OnClick="sendresults_Click" /> 
                     </div>  
                        </div>
                          </div>  
                         <br />
