<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Configuration.aspx.cs" Inherits="Admin_Configuration" %>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-default">
                                       ...
                                       <asp:HyperLink ID="brandingBtn" runat="server" CssClass="btn btn-default" Text="Branding" NavigateUrl="branding.aspx"></asp:HyperLink> 
                                            <asp:HyperLink ID="advertisingBtn" runat="server" CssClass="btn btn-default" Text="Advertising" NavigateUrl="manageAds.aspx"></asp:HyperLink> 
</div>
                                        </div>
                                            </div>
                                            <br />
