<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createPathway.aspx.cs" Inherits="Admin_createPathway" %>
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Create Pathway</h2>

                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">

                                    <!-- JC - Form to enter details for new pathway -->
                                    <div class="col-md-6">
                                        Pathway Name
                                    <asp:TextBox ID="newPathway" CssClass="form-control" runat="server"></asp:TextBox><br />
                                        Pathway Code
                                    <asp:TextBox ID="newCode" CssClass="form-control" runat="server"></asp:TextBox><br />
                                        Pathway Length
                                    <asp:TextBox ID="years" CssClass="form-control" runat="server"></asp:TextBox><br />
                                        Pathway Entry Requirements
                                    <asp:TextBox ID="newentryRequirements" CssClass="form-control" runat="server"></asp:TextBox><br />
                                    </div>
                                    <div class="col-md-6">
                                        Pathway Faculty
                                    <asp:TextBox ID="newfaculty" CssClass="form-control" runat="server"></asp:TextBox><br />
                                        Pathway School
                                    <asp:TextBox ID="newschool" CssClass="form-control" runat="server"></asp:TextBox><br />
                                        Pathway Overview
                                    <asp:TextBox ID="newoverview" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox><br />
                                    </div>

                                    <div class="col-md-12">
                                        <br />
                                        <asp:Button ID="newPathwayButton" runat="server" CssClass="btn btn-primary" Text="Submit" OnClick="newPathwayButton_Click" /></div>
