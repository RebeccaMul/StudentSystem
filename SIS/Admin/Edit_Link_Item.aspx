<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit_Link_Item.aspx.cs" Inherits="Admin_Edit_Link" %>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                   ...
                                   <div class="panel-heading">
                                    Edit your External Links below:
                                    ...
                                    <div class='panel-body'>
                                               ...
                                               <div class="col-md-4 col-sm-12 col-xs-12">
                                                      ...
                                                      <asp:SqlDataSource ID="readfromLinks" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_EXTERNAL_LINKS WHERE linkID = @lID">
                                            <SelectParameters>
                                             <asp:QueryStringParameter Name="lID" QueryStringField="linkID" />
                                             
                                            </SelectParameters>
                                        </asp:SqlDataSource>

                                                    <asp:ListView ID="displaylinks" runat="server" DataSourceID="readfromLinks">
                                                        <ItemTemplate>
                                            ...
                                            <br />
                                                        ...
                                                        <asp:SqlDataSource ID="userTypeSource" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_EXTERNAL_LINK_DETAILS"></asp:SqlDataSource>


                                               
                                       <asp:DropDownList ID="usertypeList" runat="server" CssClass="form-control" DataSourceID="userTypeSource" DataTextField="linkUser" DataValueField="linkDetailsID"></asp:DropDownList>
                                                   <asp:Label ID="displayLabel" runat="server" Font-Size="Small" Text=""></asp:Label>
</div>
<div class="col-md-8 col-sm-12 col-xs-12">

                                                        <b>Link Name:</b>
                                                           <asp:TextBox ID="linkName" CssClass="form-control" runat="server"></asp:TextBox><br />

                                                            <b>Link:</b>
                                                           <asp:TextBox ID="linkMessage" CssClass="form-control" runat="server"></asp:TextBox><br />
