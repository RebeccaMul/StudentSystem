<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit_Notification_Item.aspx.cs" Inherits="Admin_Edit_Notification" %>
                                   ...
                                   <div class="panel-heading">
                                    ...
                                    <div class='panel-body'>
                                               ...
                                               <div class="col-md-4 col-sm-12 col-xs-12">
                                                      ...
                                                      <asp:SqlDataSource ID="readfromNotification" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_NOTIFICATION WHERE notificationID = @notificationID">
                                            <SelectParameters>
                                             <asp:QueryStringParameter Name="notificationID" QueryStringField="notificationID" />
                                                    ...
                                                    <asp:ListView ID="readfromimageview" runat="server" DataSourceID="readfromNotification">
                                                        <ItemTemplate>
                                                    <asp:Image ID="notificationImage" runat="server" alt="notificationImage" CssClass="img-notification-thumbnail" width="100%" Height="150px" style="margin:auto;" ImageUrl='<%# "../../files/" + Eval("imagepath") %>' />
                                                            </ItemTemplate></asp:ListView>
                                            <br />
  <asp:Label ID="myinfo" runat="server" Text="" Enabled="false"></asp:Label>
                                                            <asp:FileUpload ID="myimage" runat="server" CssClass="form-control btn-block" Style="width: 100%;" />
                                                        
                                                 <hr />
                                                   
                                                        <asp:SqlDataSource ID="accountTypeSource" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_ACCOUNT_TYPE"></asp:SqlDataSource>


                                                  
                                        <asp:DropDownList ID="accountType" runat="server" CssClass="form-control" DataSourceID="accountTypeSource" DataTextField="accountName" DataValueField="typeID"></asp:DropDownList>
                                                   <br />
                                                   <asp:Label ID="displayLabel" runat="server" Font-Size="Small" Text=""></asp:Label>
</div>
<div class="col-md-8 col-sm-12 col-xs-12">
                                                            <b>Title:</b>
                                                           <asp:TextBox ID="notificationName" CssClass="form-control" runat="server"></asp:TextBox><br />

                                                   <asp:ListView ID="displayDate" runat="server" DataSourceID="readfromnotification">
                                                        <ItemTemplate>
                                                 
                                             <b>Date:</b>
                                                           <asp:TextBox ID="notificationDate" CssClass="form-control" runat="server" Enabled="false" Text='<%# Eval("notificationDate")  %>'></asp:TextBox><br />
                                                   </ItemTemplate>
                                                   </asp:ListView>

                                               
                                        <b>Message:</b>
                                                            <asp:TextBox ID="notificationMessage" CssClass="form-control" runat="server" TextMode="MultiLine" Height="200px" ></asp:TextBox>
                                        <br />

   
    <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-danger">Delete</button>
                                                    <asp:Button ID="saveBtn" runat="server" Text="Save Changes" CssClass="btn btn-primary submit" style="float:right;" Onclick="saveBtn_Click" /> <asp:Button ID="cancelBtn" runat="server" Text="Back" class="btn btn-default" style="float:right;" OnClick="cancelBtn_Click" />
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <asp:Button ID="deleteConfirmBtn" runat="server" Text="Delete" class="btn btn-danger" CausesValidation="false" onClick="deleteBtn_Click" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
