<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editPathway.aspx.cs" Inherits="Admin_editPathway" %>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!--JC - Form created to gather data for editing pathway information -->
                                ...
                                Pathway Code
                                    <br />
                                <asp:TextBox ID="code" Text="" CssClass="form-control" runat="server"></asp:TextBox><br />
                                Pathway Duration
                                    <br />
                                <asp:TextBox ID="year" Text="" CssClass="form-control" runat="server"></asp:TextBox><br />
                                    Pathway Requirements
                                    <br />
                                <asp:TextBox ID="entry" Text="" CssClass="form-control" runat="server"></asp:TextBox><br /></div>
                                Pathway Faculty
                                    
                                    <div class="col-md-6">
                                <asp:TextBox ID="fac" Text="" CssClass="form-control" runat="server"></asp:TextBox><br />
                               
                                    Pathway School
                                    <br />
                                <asp:TextBox ID="school" Text=""  CssClass="form-control" runat="server"></asp:TextBox><br />
                                Overview
                                    <br />
                                <asp:TextBox ID="overview" Text="" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox><br />
                            ...
                            <div class="col-md-12">
                                    ...
                                    <asp:Button ID="updatePathway" runat="server" CssClass="btn btn-primary" Text="Submit Changes" OnClick="updatePathway_Click" />

                                <BR />
                                <asp:Label ID="confirm" Text="" runat="server"></asp:Label>
                            </div>
