<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminSelectedModule.aspx.cs" Inherits="Admin_adminSelectedModule" %>
              ...
              <!-- List view to display the content from db--> <!-- Hyper link to pass module ID to next page-->
                 ...
                 <div id="div1" style="padding:10px" >       
                        ...
                        <asp:Label ID="descLabel" runat="server"  Text='<%# Eval("moduleDescription") %>' />
                         ...
                         <br />
                       <asp:Button ID="Sendresults" runat="server" Width="250px" CssClass="btn btn-primary" Text="Submit Assignment/Exam Result" OnClick="sendresults_Click" /> 
                     </div>  
                        </div>
                          </div>  
                         <br />
