<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit_Notification.aspx.cs" Inherits="Admin_Edit_Notification" %>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                   ...
                                   <div class="panel-heading">
                                    Click on a Notifications below to edit:
                                    ...
                                    <div class='panel-body'>
                                       ...
                                       <asp:SqlDataSource ID="notificationSource" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_NOTIFICATION INNER JOIN SIS_ACCOUNT_TYPE ON SIS_ACCOUNT_TYPE.typeID = SIS_NOTIFICATION.typeID ORDER BY notificationID DESC"></asp:SqlDataSource>
                                        ...
                                        <div class="panel-body">
                                                ...
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="editNotificationBtn" runat="server" Font-Underline="false" NavigateUrl='<%# "Edit_Notification_Item.aspx?notificationID="+Eval("notificationID") %>'>
                                                    ...
                                                    <b>
                                                        ...
                                                        <asp:Label ID="notificationAudience" runat="server" style="float:right;" Text='<%# Eval ("accountName")  %>'></asp:Label>
                                                        <br />
