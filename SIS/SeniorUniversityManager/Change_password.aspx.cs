...
public partial class SeniorUniversityManager_Change_password : System.Web.UI.Page
{
    ...
    protected void updatePassword_Click(object sender, EventArgs e)
    {
        ...
        if (up == 1)
        {
            ...
            cmd.Parameters.AddWithValue("@password", currentPassword.Text);
        ...
        else
        {
            ...
            //JD - Else statement used to inform the user that the validation of the current password failed. If this is the case the 1text is changed to indicate to the user that their current password was entered incorrectly. 
            passwordChangeText.Text = "Please enter correct current password!";
        }
    }
