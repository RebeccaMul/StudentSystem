...
public partial class SENIORUNIVERSITYMANAGER_viewLecturers : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        //JC - Created session variable, this can be used by timetable feature to view the timetable of the selected user
        Session["viewusertimetable"] = Request.QueryString["userID"];
