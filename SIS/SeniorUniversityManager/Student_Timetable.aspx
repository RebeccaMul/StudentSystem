<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student_Timetable.aspx.cs" Inherits="SeniorUniversityManager_StudentSUM" %>
                                           ...
                                           <div class="col-lg-3 col-md-4  col-sm-12 col-xs-12">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <asp:HyperLink ID="TimetableLink" runat="Server" Text="View Timetable" float="right" CssClass="btn btn-default" Style="float: right;"
                                                            NavigateUrl='<%# "Student_Timetable_View.aspx?studentID="+Eval("studentID") + "&userID=" + Eval ("userID") %>'>Timetable</asp:HyperLink>
                                            ...
                                            <div class="col-lg-3 col-md-4  col-sm-12 col-xs-12">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        ...
                                                        <asp:HyperLink ID="timetableLink" runat="Server" Text="" NavigateUrl='<%# "Student_Timetable_View.aspx?studentID="+Eval("studentID") + "&userID=" + Eval ("userID") %>'>
                                                            <asp:Label Text='<%# Eval("name") %>' runat="server" ID="firstNameLabel" />
