<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentSUM.aspx.cs" Inherits="SeniorUniversityManager_StudentSUM" %>
                                           ...
                                           <div class="col-lg-3 col-md-4  col-sm-12 col-xs-12">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <asp:HyperLink ID="editLink" runat="Server" Text="View Personal Information" float="right" CssClass="btn btn-default" Style="float: right;"
                                                            NavigateUrl='<%# "Student_EditSUM.aspx?studentID="+Eval("studentID") + "&userID=" + Eval ("userID") %>'>Edit</asp:HyperLink>
                                                        <asp:HyperLink ID="HyperLink1" runat="Server" Text="" NavigateUrl='<%# "Student_EditSUM.aspx?studentID="+Eval("studentID") + "&userID" + Eval ("userID") %>'>
