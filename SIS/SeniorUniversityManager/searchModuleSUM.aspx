<%@ Page Language="C#" AutoEventWireup="true" CodeFile="searchModuleSUM.aspx.cs" Inherits="SeniorUniversityManager_searchModuleSUM" %>
                                        ...
                                        <ItemTemplate>
                                           <div class="col-lg-3 col-md-4  col-sm-12 col-xs-12">
                                                <div class="panel panel-default">
                                                           ...
                                                           <asp:HyperLink ID="editBtn" runat="server" text="Class List" class="btn btn-primary" style="float: right;"  NavigateUrl='<%# "classlistSUM.aspx?moduleID="+Eval("moduleID") %>'>Class List</asp:HyperLink>
...
<div id="HTMLtoPDF">
                                                     <b>moduleDescription:</b>
                                                    <asp:Label Text='<%# Eval("moduleDescription") %>' runat="server" ID="moduleDescription" /><br />
    </div><a href="#" class="btn btn-primary"  onclick="HTMLtoPDF()">Print Module Description</a>
                                                        <br />
                                                        <br />
