<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewModuleSUM.aspx.cs" Inherits="SeniorUniversityManager_viewModuleSUM" %>
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        ...
                        <asp:HyperLink ID="HyperLink4" runat="Server" Text="Edit Personal Information" float="center" CssClass="btn btn-default"
                                                            NavigateUrl='<%# "classlistSUM.aspx?moduleID="+Eval("moduleID") %>'>Class List</asp:HyperLink>
