...
public partial class Lecturer_classList : System.Web.UI.Page
{
    ...
    protected void Searchbtn_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("classList.aspx?searchquery=" + stext);
    ...
    protected void viewContact_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("classListContactDetails.aspx?moduleid=" + moduleid);//redirect user with querystring assigned to url
