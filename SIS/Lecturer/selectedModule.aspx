<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selectedModule.aspx.cs" Inherits="Lecturer_selectedModule" %>
...
<body class="nav-md">
    <form id="form1" runat="server">
      ...
      <!-- sql data source for one table to pull data from mylittleadmin-->  <!-- Session used as filtering parameter-->
              ...
              <!-- List view to display the content from db--> <!-- Hyper link to pass module ID to next page-->
                 <asp:ListView ID="modules" runat="server" DataSourceID="displaymodule">
                     ...
                     <ItemTemplate>
                       ...
                       <h3><asp:Label ID="Label1" runat="server" Text='<%# Eval("moduleName") %>' /> 
                 ...
                 <div id="div1" style="padding:10px" >       
                        ...
                        <asp:Label ID="descLabel" runat="server"  Text='<%# Eval("moduleDescription") %>' />
                         ...
                         <label>Module Compulsary:</label>
                         
                         <asp:Label ID="priceLabel" runat="server" Text='<%# Eval("compulsary") %>' />
                         <br />
                         
                         <label>Unit Value:</label>
                         <asp:Label ID="uploaddateLabel" runat="server" Text='<%# Eval("units") %>' />
                         <br />
                
                   
                     
                        <asp:Button ID="editdesc" runat="server" CssClass="btn btn-primary" Text="Edit Module Description" OnClick="editdesc_Click" /> 
                         <asp:Button ID="Sendemail" runat="server" CssClass="btn btn-primary" Text="Email Students" OnClick="sendemail_Click" /> 
                       <asp:Button ID="Sendresults" runat="server" CssClass="btn btn-primary" Text="Submit Assignment/Exam Result" OnClick="sendresults_Click" /> 
                     <asp:Button ID="Viewlist" runat="server" CssClass="btn btn-primary" Text="Class List" OnClick="viewlist_Click" /> 
                     </div>  
                        </div>
                          </div>  
                         <br />
