<%@ Page Language="C#" AutoEventWireup="true" CodeFile="academicRecord.aspx.cs" Inherits="SIS2_Lecturer_academicRecord" %>
...
<body class="nav-md">
                                        ...
                                        <div class="panel-body">
                                            <div class="col-lg-4 col-sm-12 col-xs-12">
                                              ...
                                              <br />
                                                    ...
                                                    <asp:SqlDataSource ID="readDetails" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT studentNo, firstName, lastName, school, course, level, fName, lName FROM SIS_STUDENT INNER JOIN SIS_ADVISOR ON SIS_STUDENT.advisorID = SIS_ADVISOR.advisorID WHERE SIS_STUDENT.studentID = @studentID">
 ...
 <div id="HTMLtoPDF">
     ...
     <h2 style="margin-left=10px"><b>All Results</b></h2>
