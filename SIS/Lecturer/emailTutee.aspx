<%@ Page Language="C#" AutoEventWireup="true" CodeFile="emailTutee.aspx.cs" Inherits="Lecturer_emailTutee" %>
...
<body class="nav-md">
    <form id="form1" runat="server">
      ...
      <asp:GridView ID="GridView1" runat="server" CssClass="mydatagrid" EmptyDataText="No Tuttees Available" EmptyDataRowStyle-BorderWidth="0px" PagerStyle-CssClass="pager"
...
<!-- sql data source to join two tables, and pull data from mylittleadmin-->   <!-- Session used as filtering parameter-->
        ...
        <asp:SqlDataSource ID="displayemail" runat="server" 
         ...
         SelectCommand="SELECT SIS_STUDENT.firstname,
             SIS_STUDENT.lastname,
             SIS_USER.Email 
             FROM SIS_STUDENT INNER JOIN SIS_LECTURER ON SIS_STUDENT.tutorID = SIS_LECTURER.lecturerID 
             INNER JOIN SIS_USER ON SIS_USER.userID = SIS_STUDENT.userID WHERE SIS_LECTURER.userID= @myid">
