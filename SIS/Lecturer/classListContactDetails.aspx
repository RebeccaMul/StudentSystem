<%@ Page Language="C#" AutoEventWireup="true" CodeFile="classListContactDetails.aspx.cs" Inherits="Lecturer_classListContactDetails" %>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <asp:SqlDataSource ID="displayContactDetails" runat="server"
                                        ...
                                        SelectCommand="SELECT SIS_STUDENT.firstName, SIS_STUDENT.lastName, SIS_STUDENT.address, SIS_STUDENT.contactNumber, SIS_STUDENT.studentNo, SIS_STUDENT.termAddress, SIS_STUDENT.kinContactNumber, SIS_STUDENT.kinFirstName, SIS_STUDENT.kinLastName, SIS_STUDENT.kinAddress FROM SIS_STUDENT INNER JOIN SIS_STUDENT_MODULES ON SIS_STUDENT.studentID = SIS_STUDENT_MODULES.studentID WHERE (SIS_STUDENT_MODULES.moduleSelected = @id) AND SIS_STUDENT_MODULES.Completed = 'False'  ORDER BY SIS_STUDENT.lastName">
