<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editModule.aspx.cs" Inherits="Lecturer_editModule" %>
    ...
    <form id="form1" runat="server">
        <div class="container body">
            <div class="main_container">
                ...
                <!-- JC - Form to allow lecturer to enter a suggested change -->
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        <label for="moduledescriptionchnage" class="control-label">Submit Description change for Review</label>

                                        <asp:TextBox ID="moduletext" class="form-control" TextMode="MultiLine" runat="server" Text=""></asp:TextBox>
                                    </div>
