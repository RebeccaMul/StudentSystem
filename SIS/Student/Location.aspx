<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Location.aspx.cs" Inherits="Student_Location" %>
                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <asp:ListView ID="ListView2" runat="server" DataSourceID="StudentDetails">
                                        <ItemTemplate>
                                            <li>
                                                <asp:HyperLink ID="link" runat="server" NavigateUrl='<%# "Transcript.aspx?studentID=" + Eval("studentID")%>'><i class="fa fa-file-text-o"></i>Transcript</asp:HyperLink></li>
                                    ...
                                    <asp:ListView ID="ListView3" runat="server" DataSourceID="StudentDetails">
                                        <ItemTemplate>
                                            <li>
                                                <asp:HyperLink ID="link" runat="server" NavigateUrl='<%# "AcademicRecord.aspx?studentID=" + Eval("studentID")%>'><i class="fa fa-list-alt"></i>Academic Record</asp:HyperLink></li>
                                ...
                                <div class="x_content">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            Click a faculty below to view the building
                                       
                                        </div>
                                        <div class='panel-body'>

                                            <asp:SqlDataSource ID="facultySource" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_FACULTY"></asp:SqlDataSource>

                                            <asp:ListView ID="displayNotifications" runat="server" DataSourceID="facultySource">
                                                <EmptyDataTemplate>
                                                    No Notifications
                                                </EmptyDataTemplate>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HyperLink ID="viewRooms" runat="server" NavigateUrl='<%# "Building.aspx?facultyID="+Eval("facultyID") %>'>

                                                        <h2>
                                                            <asp:Label ID="facultyName" runat="server" Text='<%# Eval("facultyName") %>'></asp:Label></a></h2>


                                                        <asp:Image ID="image" runat="server" alt="facultyImage" CssClass="img-notification-thumbnail" Style="height: 100px;" ImageUrl='<%# "../../files/" + Eval("imagepath")  %>' />

                                                        <asp:Label ID="facultyDescription" runat="server" Text='<%# Eval("facultyDescription") %>'></asp:Label>
                                                        <br />
                                                        <asp:Label ID="facultyAddress" runat="server" Text='<%# Eval("facultyAddress") %>'></asp:Label>
                                                    </asp:HyperLink>

                                                    <br />
                                                    <asp:Label ID="facultyContact" runat="server" Text='<%# Eval("facultyContact") %>'></asp:Label>
                                                    <br />
                                                    <asp:Label ID="facultyEmail" runat="server" Text='<%# Eval("facultyEmail") %>'></asp:Label>
                                                    <asp:HyperLink ID="viewBuildingBtn" runat="server" CssClass="btn btn-default" Style="float: right" Text="View Buildings" NavigateUrl='<%# "Building.aspx?facultyID="+Eval("facultyID") %>' />
                                                    <br />
                                                    <br />
