<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegWizardFinance.aspx.cs" Inherits="Student_RegWizardFinance" %>
        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Registration Wizard - Step 2</h2>
              ...
              <u>Financial Details</u>
                  ...
                  <b> Your current fees outstanding balance is: </b> <asp:Label ID="Label8" runat="server" Text=' <%# "�" + Eval("feesOutstanding") %>'></asp:Label><br />
                            <b> Your current fees paid balance is: </b> <asp:Label ID="Label9" runat="server" Text=' <%# "�" + Eval("amountPaid") %>'></asp:Label><br />
                      </ItemTemplate>
                                  </asp:ListView>
                
                  <br /><u>Please confirm your Finance payment method:</u><br /><br />
                   <b>SFNI?</b> <asp:CheckBox ID="SFNIBox" runat="server" /><br />
                    <b>Other Payment Method?</b> <asp:CheckBox ID="OtherBox" runat="server" /><br />
                  <b>If Other, please enter your payment method:
                  </b><asp:TextBox ID="Other" runat="server"></asp:TextBox><br /><br />
                 
              <asp:ListView ID="RegButtons" runat="server" DataSourceID="studentinfo">
                  ...
                  <ItemTemplate>
                            ...
                            <div id="regbuttons" style="margin-left:38%; margin-right:38%; padding:2px;">
                              <b><asp:Label ID="Label5" runat="server" style="margin-left:1%; margin-right:1%;" Text="Are these details up to date?" ForeColor="#1ABB9C"></asp:Label></b></br>
                                      ...
                                      <asp:SqlDataSource ID="manbtn" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' 
                          SelectCommand="SELECT * FROM SIS_USER WHERE SIS_USER.userID = @UID">
                          <SelectParameters>
                  <asp:QueryStringParameter QueryStringField="userid" Name="UID" Type="String"></asp:QueryStringParameter>
               </SelectParameters>
                    ...
                    <asp:Button ID="EditBtn" CssClass="btn btn-primary" runat="server" Text="Confirm" OnClick="EditBtn_Click" />
                     <asp:ListView ID="cancelbutton" runat="server" DataSourceID="manbtn">
                          <ItemTemplate>
