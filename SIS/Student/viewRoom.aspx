<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewRoom.aspx.cs" Inherits="Student_viewRoom" %>
                                ...
                                <div class="x_content">
                                    <div class="panel panel-default">
                                        ...
                                        <div class='panel-body'>
                                            ...
                                            <asp:SqlDataSource ID="roomSource" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_ROOMS WHERE SIS_ROOMS.roomID = @roomID">
                                             ...
                                             <asp:QueryStringParameter Name="roomID" QueryStringField="roomID" />
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                            <asp:ListView ID="displayRoom" runat="server" DataSourceID="roomSource">
                                                <EmptyDataTemplate>
                                                    No Rooms to show
                                                </EmptyDataTemplate>

                                                <ItemTemplate>
                                                      <div class="col-md-12 col-sm-12 col-xs-12"> <h3>     <asp:Label ID="roomName" runat="server" Text='<%# Eval("roomName") %>'></asp:Label></h3> 
      <asp:Image ID="image" runat="server" alt="roomImage" CssClass="img-notification-thumbnail" Style="width:400px; height: 200px;" ImageUrl='<%# "../../files/" + Eval("imagepath")  %>' />
                                                    <br />                                                        
                                                          </div>
                                                       ...
                                                       <div class="col-md-12 col-sm-12 col-xs-12">
                                                           <hr />
                                                          <h3>Type</h3>
                                                          <asp:Label ID="roomType" runat="server" Text='<%# Eval("roomType") %>'></asp:Label>
                                                           </div>
                                                
                                                    <br />
                                                         <div class="col-md-12 col-sm-12 col-xs-12">
                                            <h3>Capacity</h3>
                                                                   <asp:Label ID="roomCapacity" runat="server" Text='<%# Eval("roomCapacity") %>'></asp:Label>
                                                    ...
                                                    <br />
                                                       <div class="col-md-12 col-sm-12 col-xs-12">
                                            <h3>Facilities</h3>
                                                                   <asp:Label ID="roomFacilities" runat="server" Text='<%# Eval("roomFacilities") %>'></asp:Label>
