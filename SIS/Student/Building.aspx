<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Building.aspx.cs" Inherits="Student_Building" %>
                                ...
                                <div class="x_content">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            Click a building below to view the rooms
                                       
                                        </div>
                                        <div class='panel-body'>

                                            <asp:SqlDataSource ID="buildingSource" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SIS_BUILDING INNER JOIN SIS_FACULTY ON SIS_FACULTY.facultyID = SIS_BUILDING.facultyID WHERE SIS_BUILDING.facultyID = @facultyID"> 
                                                
                                                <SelectParameters>
                                             <asp:QueryStringParameter Name="facultyID" QueryStringField="facultyID" />
                                            ...
                                            <asp:ListView ID="displayNotifications" runat="server" DataSourceID="buildingSource">
                                                <EmptyDataTemplate>
...
<asp:HyperLink ID="viewRooms" runat="server" NavigateUrl='<%# "Rooms.aspx?buildingID="+Eval("buildingID") %>'> <b><asp:Label ID="facultyEmail" runat="server" Text='<%# Eval("buildingName") %>'></asp:Label></b>
